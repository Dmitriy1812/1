...
document.addEventListener('DOMContentLoaded', function () {
  var accordions = document.querySelectorAll('.aaccordion');
  accordions.forEach(function (el) {
    el.addEventListener('click', function (e) {
      var self = e.currentTarget;
      var selfcontrol = self.querySelector('.aaccordion__control');
      var selfcontent = self.querySelector('.aaccordion__content');
      ...
      accordions.forEach(function (ac) {
        if (ac !== self & ac.classList.contains('open')) {
          console.log(self);
          console.log(ac);
          var accontrol = ac.querySelector('.aaccordion__control');
          var accontent = ac.querySelector('.aaccordion__content');
...
var pportSlider = document.querySelector('.pportfolio-section__items');

if (pportSlider) {
  var pportfolioSlider = new Swiper(pportSlider, {
    slidesPerView: 1,
    spaceBetween: gap,
    on: {
      init: function init() {
        var activeSlide = pportSlider.querySelector('.swiper-slide-active');
        var nextActiveSlide = activeSlide.nextElementSibling;
        var nextNextActiveSlide = nextActiveSlide.nextElementSibling;
        activeSlide.classList.add('slider-visible');
        nextActiveSlide.classList.add('slider-visible');
    ...
    navigation: {
      nextEl: '.pportfolio-section__next',
      prevEl: '.pportfolio-section__prev'
    },
    breakpoints: {
      576: {
        slidesPerView: 2
  ...
  document.querySelector('.pportfolio-section__prev').addEventListener('click', function () {
    var activeSlide = pportSlider.querySelector('.swiper-slide-next');
    document.querySelectorAll('.pportfolio-section__items .swiper-slide').forEach(function (el) {
      el.classList.remove('slider-visible');
    });
  ...
  document.querySelector('.pportfolio-section__next').addEventListener('click', function () {
    var activeSlide = pportSlider.querySelector('.swiper-slide-active');
    var nextActiveSlide = activeSlide.nextElementSibling;
    var nextNextActiveSlide = nextActiveSlide.nextElementSibling;
    document.querySelectorAll('.pportfolio-section__items .swiper-slide').forEach(function (el) {
